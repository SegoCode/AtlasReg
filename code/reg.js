...
// Get initialDir and outputDir from command line arguments
const args = process.argv.slice(2);
if (args.length < 2) {
  console.error(colors.red('Usage: node script.js <initialDir> <outputDir>'));
  process.exit(1);
}
...
readFilesRecursively(initialDir, initialDir, outputDir);
